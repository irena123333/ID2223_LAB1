...
def g():
    ...
    dfi.export(df_recent, './df_recent_1.png', table_conversion = 'matplotlib')
    dataset_api.upload("./df_recent_1.png", "Resources/images", overwrite=True)
    ...
    if predictions.value_counts().count() == 3:
        ...
        dataset_api.upload("./confusion_matrix_1.png", "Resources/images", overwrite=True)
    else:
